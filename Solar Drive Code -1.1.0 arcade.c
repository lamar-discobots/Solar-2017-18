...
#pragma config(Motor,  port3,           liftR,         tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_2)
...
#pragma config(Motor,  port7,           right2,        tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
...
while(nMotorEncoder[right2] < 48*627.2/12.5)
{
	motor(right1) = motor(right2) = motor(left1) = motor(left2) = 127;
}
